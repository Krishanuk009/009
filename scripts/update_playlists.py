...
def fetch_star_sports(url: str) -> str:
    ...
    def is_star_sports(ch: dict[str, Any]) -> bool:
        category = value_from(ch, "category").lower()
        name = value_from(ch, "name", "title").lower()
        # The supplied source script specifically filtered Sports + "star sports".
        return category == "sports" and "star sports" in name
